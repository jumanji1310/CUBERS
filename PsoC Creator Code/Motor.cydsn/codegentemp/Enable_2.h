...
void    Enable_2_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Enable_2_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Enable_2__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Enable_2_SetInterruptMode() function.
     *  @{
     */
        #define Enable_2_INTR_NONE      (uint16)(0x0000u)
        #define Enable_2_INTR_RISING    (uint16)(0x0001u)
        #define Enable_2_INTR_FALLING   (uint16)(0x0002u)
        #define Enable_2_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Enable_2_INTR_MASK      (0x01u) 
#endif /* (Enable_2__INTSTAT) */
...
/* SIO registers */
#if defined(Enable_2__SIO_CFG)
    #define Enable_2_SIO_HYST_EN        (* (reg8 *) Enable_2__SIO_HYST_EN)
    #define Enable_2_SIO_REG_HIFREQ     (* (reg8 *) Enable_2__SIO_REG_HIFREQ)
    #define Enable_2_SIO_CFG            (* (reg8 *) Enable_2__SIO_CFG)
    #define Enable_2_SIO_DIFF           (* (reg8 *) Enable_2__SIO_DIFF)
#endif /* (Enable_2__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Enable_2_0_INTTYPE_REG 		(* (reg8 *) Enable_2__0__INTTYPE)
#endif /* (Enable_2__INTSTAT) */
