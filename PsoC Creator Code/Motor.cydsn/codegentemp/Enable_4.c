...
*
* \funcusage
*  \snippet Enable_4_SUT.c usage_Enable_4_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable_4_SUT.c usage_Enable_4_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable_4_SUT.c usage_Enable_4_Read  
*******************************************************************************/
...
* preferred Enable_4_Read() API because the 
* Enable_4_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Enable_4_SUT.c usage_Enable_4_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Enable_4_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Enable_4_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Enable_4_0_INTR       (First pin in the list)
    *  - Enable_4_1_INTR       (Second pin in the list)
    *  - ...
    *  - Enable_4_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Enable_4_SUT.c usage_Enable_4_SetInterruptMode
    *******************************************************************************/
    void Enable_4_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Enable_4_0_INTR) != 0u) 
		{ 
			 Enable_4_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Enable_4_SUT.c usage_Enable_4_ClearInterrupt
    *******************************************************************************/
