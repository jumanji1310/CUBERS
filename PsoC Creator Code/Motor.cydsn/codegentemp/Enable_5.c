...
*
* \funcusage
*  \snippet Enable_5_SUT.c usage_Enable_5_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable_5_SUT.c usage_Enable_5_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Enable_5_SUT.c usage_Enable_5_Read  
*******************************************************************************/
...
* preferred Enable_5_Read() API because the 
* Enable_5_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Enable_5_SUT.c usage_Enable_5_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Enable_5_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Enable_5_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Enable_5_0_INTR       (First pin in the list)
    *  - Enable_5_1_INTR       (Second pin in the list)
    *  - ...
    *  - Enable_5_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Enable_5_SUT.c usage_Enable_5_SetInterruptMode
    *******************************************************************************/
    void Enable_5_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Enable_5_0_INTR) != 0u) 
		{ 
			 Enable_5_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Enable_5_SUT.c usage_Enable_5_ClearInterrupt
    *******************************************************************************/
